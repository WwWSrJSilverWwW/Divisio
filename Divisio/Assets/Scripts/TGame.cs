...
public class TGame : MonoBehaviour
{
    ...
    public class LevelStructure {
        ...
        public string Tenter = "0,2";
        public string Texit = "4,2";
        public int N = 4, M = 4;
    }
    ...
    public void ResetContinue() {
        SceneManager.LoadScene("TGameScene");
    }
    ...
    private void AnimateAll(func cont) {
        ...
        StartCoroutine(Animate("StandartButton", "UpMenu"));
        StartCoroutine(Animate("StandartButton (1)", "DownReset"));
        StartCoroutine(Animate("UpButton (1)", "Appear"));
        StartCoroutine(Animate("DownButton (1)", "Appear"));
        StartCoroutine(Animate("RightButton (1)", "Appear"));
        StartCoroutine(Animate("LeftButton (1)", "Appear"));
        StartCoroutine(Animate("Line", "MoveLine", cont, true));
    }
